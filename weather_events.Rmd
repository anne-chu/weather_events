...
ggplot(top10health)+aes(x=EVTYPE, y=health, fill=EVTYPE) +
    ...
    labs(title = "Top 10 Events Affecting Population Health", x = "Weather Event Type", 
...
ggplot(top10dmg)+aes(x=EVTYPE, y=econ, fill=EVTYPE) +
    geom_bar(stat="identity") + 
    labs(title = "Top 10 Events Affecting Economy", x = "Weather Event Type", 
    y = "Total Property/Crop Damage (USD)") +
    theme_bw() +
    theme(axis.text.x=element_text(angle=45,hjust=1))
```
